...
export default function CustomNodeExample(props:CustomCanvasProp) {
	...
	engine.getModel().addAll(node_1, node_2, new VariableNodeModel("test2", false), new LayerNodeModel({name:"Layer 3", type:LayerType.LINEAR, activation:ActivationType.RELU, inputNum:2, outputNum:5}));
